...
var
	// Map over uEdit in case of overwrite
	_uEdit = window.uEdit,

	// Map over the ue in case of overwrite
	_ue = window.ue;

uEdit.noConflict = function( deep ) {
	if ( window.ue === uEdit ) {
		window.ue = _ue;
	}

	if ( deep && window.uEdit === uEdit ) {
		window.uEdit = _uEdit;
	}
...
// Expose uEdit and ue identifiers, even in AMD
// (#7102#comment:10, https://github.com/uEdit/uEdit/pull/557)
// and CommonJS for browser emulators (#13566)
if ( typeof noGlobal === strundefined ) {
	window.uEdit = window.ue = uEdit;
}
